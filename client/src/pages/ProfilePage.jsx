            ...
            <div style={{
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <p style={{ 
                  margin: '0',
                  padding: '12px',
                  backgroundColor: editing ? '#f0f0f0' : 'white',
                  border: '1px solid #ced4da',
                  borderRadius: '4px',
                  fontSize: '16px',
                  color: '#212529'
              ...
              <div style={{ marginBottom: '0' }}>
                ...
                {editing ? (
                  <input 
                    ...
                    onChange={handleChange} 
                    placeholder="e.g., Data Security, Network Security, Compliance"
                    style={{ 
                      width: '100%', 
                      padding: '12px',
                      border: '2px solid #ced4da',
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                {editing ? (
                  ...
                  <p style={{ 
                    ...
                    {profile?.weeklyAvailability ? `${profile.weeklyAvailability} hours` : 'Not specified'}
                  </p>
                )}
              </div>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                {editing ? (
                  <input 
                    ...
                    onChange={handleChange} 
                    placeholder="e.g., Penetration Testing, Vulnerability Assessment, Incident Response"
                    style={{ 
                      width: '100%', 
                      padding: '12px',
                      border: '2px solid #ced4da',
